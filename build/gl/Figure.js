import * as THREE from '../libs/js/three.min.js';
import { TweenMax as TM } from '../libs/js/gsap/index.js';

var vertexShader;
var fragmentShader;

$.get("./gl/vertexShader.glsl", function(el) {
    vertexShader = el;
});

$.get("./gl/fragmentShader.glsl", function(el) {
    fragmentShader = el;
});
